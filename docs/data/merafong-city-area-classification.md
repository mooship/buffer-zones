# Merafong City Included-Area Classification
...
Stats SA does not publish a `township` boundary type in this dataset. The inclusion set is therefore a project classification, not an official or exhaustive list of Merafong City townships.
...
Merafong City's municipality code (`MN_CODE`) in the Stats SA Census 2011 sub-place shapefile is 766 (`MN_MDB_C` GT484).
