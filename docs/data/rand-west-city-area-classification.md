# Rand West City Included-Area Classification
...
- all Rand West City Census 2011 sub-places used for municipality-wide comparison; and
- a current inclusion set of township and historically marginalised settlement areas highlighted with dissolved outlines.

Stats SA does not publish a `township` boundary type in this dataset. The inclusion set is therefore a project classification, not an official or exhaustive list of Rand West City townships.
...
Rand West City was formed after Census 2011 by merging Randfontein and Westonaria. In the Census 2011 sub-place shapefile this is represented by two municipality codes: 764 (Randfontein, `MN_MDB_C` GT482) and 765 (Westonaria, `MN_MDB_C` GT483).
