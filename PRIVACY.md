...
Buffer Zones is a static site with no backend, no accounts, no cookies, and no
...
**Map tiles:** the basemap tile providers (OpenStreetMap, CARTO, Esri) may log
tile requests, including IP address, as part of serving imagery. CARTO tiles
are used for the dark-theme basemap. This is standard for any web map.
